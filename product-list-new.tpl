...
{if $page_name =='index'}
		{if Configuration::get("{$xprtshortname}per_line_home") == 2}
	        ...
	        {assign var='nbItemsPerLinelrgMobile' value=2}
	        {assign var='prd_per_column' value=6}
	        {assign var='prd_per_column_tab' value=6}
	        {assign var='prd_per_column_mob' value=12}
	        {assign var='prd_per_column_lrgmob' value=6}
	    ...
	    {elseif Configuration::get("{$xprtshortname}per_line_home") == 3}
	        ...
	        {assign var='nbItemsPerLineMobile' value=1}
	        {assign var='nbItemsPerLinelrgMobile' value=2}
	        {assign var='prd_per_column' value=4}
	        {assign var='prd_per_column_tab' value=4}
	        {assign var='prd_per_column_mob' value=12}
	        {assign var='prd_per_column_lrgmob' value=6}
	    ...
	    {elseif Configuration::get("{$xprtshortname}per_line_home") == 4}
	        ...
	        {assign var='nbItemsPerLineTablet' value=3}
	        {assign var='nbItemsPerLineMobile' value=3}
	        {assign var='nbItemsPerLinelrgMobile' value=3}
	        {assign var='prd_per_column' value=3}
	        {assign var='prd_per_column_tab' value=4}
	        {assign var='prd_per_column_mob' value=12}
	        {assign var='prd_per_column_lrgmob' value=4}
		...
		{elseif Configuration::get("{$xprtshortname}per_line_home") == 6}
	        ...
	        {assign var='nbItemsPerLinelrgMobile' value=4}
	        {assign var='prd_per_column' value=2}
	        {assign var='prd_per_column_tab' value=3}
	        {assign var='prd_per_column_mob' value=12}
	        {assign var='prd_per_column_lrgmob' value=3}
	...
	{elseif $page_name =='category'}
	    ...
	    {elseif Configuration::get("{$xprtshortname}per_line_category") == 4}
	        ...
	        {assign var='prd_per_column_tab' value=4}
	        {assign var='prd_per_column_mob' value=12}
	        {assign var='prd_per_column_mob' value=4}
	...
	<ul{if isset($id) && $id} id="{$id}"{/if} class="product_list grid row{if isset($class) && $class} {$class}{/if} {if $xprt.gray_image_bg == 1}gray_image_bg{/if}">
	{foreach from=$products item=product name=products}
		...
		{math equation="(total%perLineT)" total=$smarty.foreach.products.total perLineT=$nbItemsPerLinelrgMobile assign=totModulolrgMobile}
		{if $totModulolrgMobile == 0}{assign var='totModulolrgMobile' value=$nbItemsPerLinelrgMobile}{/if}

		<li class="ajax_block_product col-xs-{$prd_per_column_mob} col-sm-{$prd_per_column_lrgmob} col-md-{$prd_per_column_tab} col-lg-{$prd_per_column} {if $smarty.foreach.products.iteration%$nbItemsPerLine == 0} last-in-line {elseif $smarty.foreach.products.iteration%$nbItemsPerLine == 1} first-in-line {/if}{if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulo)} last-line {/if}{if $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 0} last-item-of-tablet-line {elseif $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 1} first-item-of-tablet-line 
		{/if} {if $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 0} last-item-of-mobile-line
		{elseif $smarty.foreach.products.iteration%$nbItemsPerLineMobile == 1} first-item-of-mobile-line 
		{/if} {if $smarty.foreach.products.iteration%$nbItemsPerLinelrgMobile == 0} last-item-of-lrgmobile-line {elseif $smarty.foreach.products.iteration%$nbItemsPerLinelrgMobile == 1} first-item-of-lrgmobile-line {/if} {if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModuloMobile)} last-mobile-line {/if} {if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulolrgMobile)} last-lrgmobile-line {/if} ">
					...
					<div class="product-image-container">
						<div class="product_img_link">
							<a href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url">
								<img class="multi_img replace-2x img-responsive lazy" data-imgs-attr="{hook h='productgridmultiimgs' product=$product count='false' img_type='home_default'}" data-echo="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8'}" src="{$img_dir}kr_loader.gif" alt="{if !empty($product.legend)}{$product.legend|escape:'html':'UTF-8'}{else}{$product.name|escape:'html':'UTF-8'}{/if}" title="{if !empty($product.legend)}{$product.legend|escape:'html':'UTF-8'}{else}{$product.name|escape:'html':'UTF-8'}{/if}" itemprop="image" />
							</a>
						</div>
