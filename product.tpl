...
{capture name='displayProductRightSidebar'}{hook h='displayProductRightSidebar'}{/capture}
...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row {$xprt.prod_page_style} {if $xprt.prod_page_style == 'prod_thumb_bottom_sidebar' && $smarty.capture.displayProductRightSidebar}prod_sidebar{/if}">
		{if !$content_only}
			<div class="container">
					...
					<div class="product_attributes clearfix">
						...
						{if isset($groups)}
							...
							<div id="attributes">
								...
								{if $smarty.get.need == 1} <div class="need_err1">{l s='*Būtina pasirinkti'} </div>  {/if}
